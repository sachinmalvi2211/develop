 ...
 */
package de.hybris.demo.core.suggestion;
...
import de.hybris.demo.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/democore/test/testSimpleSuggestionService.csv", "utf-8");
	}
