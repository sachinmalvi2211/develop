...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demostorefront/electronics/en",
						"https://electronics.local:9002/demostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demostorefront/electronics/en",
						"https://electronics.local:9002/demostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/demostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demostorefront/electronics/en",
						"https://electronics.local:9002/demostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demostorefront",
						"https://electronics.local:9002/demostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demostorefront",
						"https://electronics.local:9002/demostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/demostorefront/electronics/en",
						"https://electronics.local:9002/demostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
