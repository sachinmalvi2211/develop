 ...
 */
package de.hybris.demo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DemoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DemoFulfilmentProcessConstants.PARENT_PROCESS);
