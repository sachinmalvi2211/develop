 ...
 */
package de.hybris.demo.fulfilmentprocess.test.jobs;
...
import de.hybris.demo.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = DemoFulfilmentProcessConstants.ORDER_PROCESS_NAME;
